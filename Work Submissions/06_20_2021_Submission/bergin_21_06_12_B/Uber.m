...
print('UBERSmoothedVHistorical','-dpdf') % create pdf at end
hold
pause
...
hold off
print('UBER','-dpdf') % create pdf at end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% NOW to the predictions
load('UBERFuture.csv');%load the future data
...
legend('model','closing prices','errorband'),
hold
print('UBERFuture','-dpdf') % create pdf at end