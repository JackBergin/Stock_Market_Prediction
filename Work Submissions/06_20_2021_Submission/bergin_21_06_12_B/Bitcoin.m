...
print('BTCSmoothedVHistorical','-dpdf') % create pdf at end
hold
pause
...
hold off
print('BTC','-dpdf') % create pdf at end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% NOW to the predictions
load('BTCFuture.csv');%load the future data
...
legend('model','closing prices','errorband'),
hold
print('BTCFuture','-dpdf') % create pdf at end
