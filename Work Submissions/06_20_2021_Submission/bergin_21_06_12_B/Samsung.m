...
print('SAMSNGSmoothedVHistorical','-dpdf') % create pdf at end
hold
pause
...
hold off
print('SAMSNG','-dpdf') % create pdf at end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% NOW to the predictions
load('SAMSNGFuture.csv');%load the future data
...
legend('model','closing prices','errorband'),
hold
print('SAMSNGFuture','-dpdf') % create pdf at end
