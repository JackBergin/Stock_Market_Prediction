clear all
load ('DOGE.csv');%the file containing the historical data  for this stock
prclose=DOGE(:,5);
[m,n]=size(prclose)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
print('DOGESmoothedVHistorical','-dpdf') % create pdf at end
hold
pause
...
hold off
print('DOGE','-dpdf') % create pdf at end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% NOW to the predictions
load('DOGEFuture.csv');%load the future data
...
legend('model','closing prices','errorband'),
hold
print('DOGEFuture','-dpdf') % create pdf at end
