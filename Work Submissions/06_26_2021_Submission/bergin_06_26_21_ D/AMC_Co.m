...
% the data in "AMC.csv" is arranged so the first row is the oldest data
...
load('AMCfuture.csv');%load txhe future data
...
for i=1:m
RV1(i+rp)=AMCfuture(i,5)/today_price;
end
...
title('AMC Prototype+Market influence')
