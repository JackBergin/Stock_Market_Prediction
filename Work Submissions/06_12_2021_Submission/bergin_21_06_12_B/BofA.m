...
print('BACSmoothedVHistorical','-dpdf') % create pdf at end
hold
pause
...
hold off
print('BAC','-dpdf') % create pdf at end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% NOW to the predictions
load('BACFuture.csv');%load the future data
...
legend('model','closing prices','errorband'),
hold
print('BACFuture','-dpdf') % create pdf at end
