...
print('MSSmoothedVHistorical','-dpdf') % create pdf at end
hold
pause
...
hold off
print('MS','-dpdf') % create pdf at end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% NOW to the predictions
load('MSFuture.csv');%load the future data
...
legend('model','closing prices','errorband'),
hold
print('MSFuture','-dpdf') % create pdf at end
