...
print('BNEDSmoothedVHistorical','-dpdf') % create pdf at end
hold
pause
...
hold off
print('BNED','-dpdf') % create pdf at end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% NOW to the predictions
load('BNEDFuture.csv');%load the future data
...
legend('model','closing prices','errorband'),
hold
print('BNEDFuture','-dpdf') % create pdf at end
